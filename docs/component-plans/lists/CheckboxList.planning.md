# CheckboxList Planning

## Source

- Figma node: `7673:5287`
- Figma name: `Checkbox List`
- Atomic level: atoms
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>No.Items and visibility booleans map to simple props; row content remains controlled by prefixes and counts.</td>
    </tr>
  </tbody>
</table>
